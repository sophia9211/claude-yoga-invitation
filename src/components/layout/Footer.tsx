...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#5B7C6C] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Studio Info */}
          <div>
            <h3 className="mb-4 text-lg font-semibold">Serenity Yoga</h3>
            ...
            <ul className="space-y-2">
              {businessHours.map((item) => (
                <li key={item.day} className="text-sm">
                  <span className="text-gray-200">{item.day}</span>
                  <br />
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic text-gray-200">
        ...
        <div className="mt-8 border-t border-white/20 pt-8 text-center text-sm text-gray-200">
          <p>&copy; {currentYear} Serenity Yoga. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
